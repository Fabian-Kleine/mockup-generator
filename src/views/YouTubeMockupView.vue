...
<template>
    <div id="capture">
        ...
        <div class="block xl:grid grid-cols-4 mx-16 xl:mx-24 mt-10 gap-4">
            <div class="col-span-3 mb-5 xl:mb-0">
                <div v-if="!thumbnail" class="bg-neutral-700 w-full aspect-video rounded-xl"></div>
                <div v-if="thumbnail" class="w-full aspect-video rounded-xl overflow-hidden">
                ...
                <div class="flex justify-between items-center h-[40px]">
                    ...
                    <div class="flex items-center gap-2 h-full">
                        ...
                        <button
                            class="flex justify-center items-center gap-2 bg-neutral-700 px-4 h-full rounded-full font-bold text-sm">
                        ...
                        <button
                            class="flex justify-center items-center gap-2 bg-neutral-700 aspect-square h-full rounded-full font-bold text-sm"
            ...
            <div class="space-y-4">
                <div class="flex gap-2" v-for="recommended in recommendedVideosLength">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="bg-neutral-700 w-16 h-2 rounded-xl mt-4 mb-2"></div>
                        <div class="bg-neutral-700 w-full h-2 rounded-xl mt-2"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <Dialog v-model:visible="editDialogVisible" modal header="Edit Mockup" :style="{ width: '35rem' }">
        <p class="mb-6">
            ...
            Further you can edit the Title, the amount of subscribers and the amount of likes directly in inside the mockup.
        </p>
