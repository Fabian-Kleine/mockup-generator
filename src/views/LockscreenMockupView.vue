    ...
    <div class="w-full min-h-screen block xl:grid grid-cols-4 gap-4">
        ...
        <div :style="background == 'linear-gradient' ? { 'background-image': `linear-gradient(${gradientAngle}deg, #${gradientColors.color1}, #${gradientColors.color2})` }
            ...
            <div :class="['relative rounded-[2.5rem] border-neutral-800 bg-neutral-800 border-[14px] h-[600px] w-[300px]', background != 'none' ? 'shadow-2xl' : '']"
                ...
                <div class="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white bg-cover bg-center flex flex-col"
    ...
    <Dialog v-model:visible="phoneBgDialog" modal header="Select Phone Background" :style="{ width: '50%' }">
        ...
        <div class="flex gap-3 flex-wrap justify-center">
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/iOS-17-light.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>iOS 17 light</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/iOS-17-light.png'; phoneBgDialog = false"/>
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/iOS-15-dark.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>iOS 15 dark</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/iOS-15-dark.png'; phoneBgDialog = false" />
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/iOS-7.jpg)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>iOS 7</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/iOS-7.jpg'; phoneBgDialog = false" />
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/iPhone-14.jpg)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>iPhone 14</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/iPhone-14.jpg'; phoneBgDialog = false" />
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/iPhone-12-pro-gray.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>iPhone 12 Pro Gray</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/iPhone-12-pro-gray.png'; phoneBgDialog = false" />
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/iPhone-12-pro-blue.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>iPhone 12 Pro Blue</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/iPhone-12-pro-blue.png'; phoneBgDialog = false" />
                </template>
            </Card>
        </div>
        ...
        <div class="flex gap-3 flex-wrap justify-center">
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/samsung-z-flip-6-green.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>Z Flip 6 Green</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/samsung-z-flip-6-green.png'; phoneBgDialog = false"/>
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/samsung-z-flip-6-blue.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>Z Flip 6 Blue</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/samsung-z-flip-6-blue.png'; phoneBgDialog = false"/>
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/samsung-z-flip-6-purple.jpg)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>Z Flip 6 Purple</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/samsung-z-flip-6-purple.jpg'; phoneBgDialog = false"/>
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/samsung-z-flip-6-gray.jpg)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>Z Flip 6 Gray</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/samsung-z-flip-6-gray.jpg'; phoneBgDialog = false"/>
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/Samsung-Galaxy-A54.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>A54</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/Samsung-Galaxy-A54.png'; phoneBgDialog = false"/>
                </template>
            </Card>
            <Card class="w-1/4 p-2">
                <template #header>
                    <div class="bg-[url(/phone-backgrounds/Samsung-Galaxy-A54-blur.png)] bg-cover w-[200px] h-[450px] rounded-md mx-auto"></div>
                </template>
                <template #title>A54 Blured</template>
                <template #footer>
                    <Button label="Select Background" class="w-full" @click="phoneBg = '/phone-backgrounds/Samsung-Galaxy-A54-blur.png'; phoneBgDialog = false"/>
                </template>
            </Card>
        </div>
        ...
        <div class="flex gap-3 edit-tweet flex-wrap justify-center mt-4">
            <FileUpload :chooseButtonProps="{ class: 'w-max' }" mode="basic" accept="image/*"
