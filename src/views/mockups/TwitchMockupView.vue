...
<template>
    ...
    <EditorSidebar drawer v-model:drawerOpen="editDialogVisible" header="Edit Mockup" downloadFilename="twitch-mockup.png">
        ...
        <div class="flex flex-col gap-2">
            <FileInput v-model:image="proiflePicture" imageName="Profile Picture" defaultImage="./x_placeholder.png" align="horizontal" />
            <FileInput v-model:image="thumbnail" imageName="Stream Thumbnail" align="horizontal" />
