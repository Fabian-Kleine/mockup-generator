...
<template>
    <div class="w-full min-h-screen block xl:grid grid-cols-4 gap-4">
        <div class="flex flex-col gap-4 mt-4 px-4 mb-10 xl:mb-0">
            <h2 class="text-xl font-bold">Edit Laptop Mockup</h2>
            <IftaLabel>
            ...
            <div class="flex gap-2 mt-4">
                ...
                <Button class="flex-1" label="Download" @click="downloadCapture('laptop-mockup.png')" />
            </div>
        </div>
        <div :style="background == 'linear-gradient' ? { 'background-image': `linear-gradient(${gradientAngle}deg, #${gradientColors.color1}, #${gradientColors.color2})` }
            ...
            <div class="w-full" :id="background == 'none' ? 'capture' : ''">
                <div
                    :class="['relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[8px] rounded-t-xl h-[172px] max-w-[301px] md:h-[294px] md:max-w-[512px]', background != 'none' ? 'shadow-2xl' : '']">
                    <div class="rounded-sm overflow-hidden aspect-video h-[156px] md:h-[278px] bg-white dark:bg-gray-800 bg-center bg-cover" :style="laptopBg ? { 'background-image': `url(${laptopBg})` } : {}">
                    </div>
                </div>
                <div
                    :class="['relative mx-auto bg-gray-900 dark:bg-gray-700 rounded-b-xl rounded-t-sm h-[17px] max-w-[351px] md:h-[21px] md:max-w-[597px]', background != 'none' ? 'shadow-2xl' : '']">
                    <div
